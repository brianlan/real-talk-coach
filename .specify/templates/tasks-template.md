...
> Use mocks/stubs for any external services to keep the loop fast and deterministic.
...
- [ ] TXXX [P] Additional edge-case unit tests in tests/unit/
...
- Tests MUST be written and FAIL before implementation (TDD-first)
